      ...
      <div className="instructions-view__rules">
        ...
        <div className="instructions-view__rule-tile">
          ...
          <p className="instructions-view__rule-text">
            ...
            <span className="instructions-view__chip instructions-view__chip--win">
              WIN
            </span>
            {",  "}roll <strong>2</strong>, <strong>3</strong> or{" "}
            <strong>12</strong> →{" "}
            <span className="instructions-view__chip instructions-view__chip--lose">
              LOSE
            </span>
          </p>
        </div>
        ...
        <div className="instructions-view__rule-tile">
          ...
          <p className="instructions-view__rule-text">
            Any other number sets the <strong>point</strong>. Keep rolling —
            match it to{" "}
            <span className="instructions-view__chip instructions-view__chip--win">
              WIN
            </span>
